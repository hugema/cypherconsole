feature 'Run query with parameters on Neo4j', :js => true do
  ...
  scenario 'Put server, query, parameter and submit form' do
    visit '/'
    ...
    expect(page).to have_css "li.active > #tab_data"
    page.evaluate_script("document.getElementById('tab_json').click()");
    expect(page).to have_css "li.active > #tab_json"
  end
